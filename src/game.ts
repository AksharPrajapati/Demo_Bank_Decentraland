...
const transform8 = new Transform({
  ...
  rotation: new Quaternion(
    3.161013495400766e-8,
    -0.7071068286895752,
    5.2683553519727866e-8,
    0.7071068286895752
  ),
...
const gltfShape3 = new GLTFShape(
  "91515a72-8f9f-4e7b-8ca5-a4dec6f99402/WhiteCorner.glb"
);
...
const transform12 = new Transform({
  ...
  rotation: new Quaternion(
    -0.70710688829422,
    1.2644051139432122e-7,
    0.7071067690849304,
    -4.214689397485927e-8
  ),
  scale: new Vector3(
    1.0000040531158447,
    1.5000032186508179,
...
const gltfShape4 = new GLTFShape(
  "2583def2-238b-448f-a191-de5e48fbfff1/FancyPillar.glb"
);
...
const gltfShape5 = new GLTFShape(
  "3e7afb1d-3108-475c-a343-57c7f33554a8/HorizontalBoardWall.glb"
);
...
const gltfShape6 = new GLTFShape(
  "604e60fd-ecd9-4bc8-a0de-6ff71ad4fd48/CreamFloor_Small.glb"
);
...
const gltfShape7 = new GLTFShape(
  "61265486-0bbb-462e-80c0-30754daf97ed/Coffee_Table.glb"
);
...
const gltfShape71 = new GLTFShape(
  "61265486-0bbb-462e-80c0-30754daf97ed/men4.glb"
);
...
const fakeResponse = {
  1: "Sure, Can you please provide me your account number?",
  2: "Which kind of loan you are looking for?",
  3: "Yes, we provide home loan, Do you have cheque book ?",
...
const gltfShape9 = new GLTFShape(
  "a9bb84fd-6556-4d92-bdd3-d66ffe963b3e/Sofa_Black.glb"
);
...
const gltfShape10 = new GLTFShape(
  "82ffe8b2-1845-499b-9287-67b022348430/HighStool.glb"
);
...
const gltfShape13 = new GLTFShape(
  "122cdf10-4c2f-437d-933a-0322ff126b5d/Piano chair.glb"
);
...
const gltfShape14 = new GLTFShape(
  "3a29e237-7096-4795-95b7-038c2d584a23/Book_03/Book_03.glb"
);
...
const gltfShape15 = new GLTFShape(
  "167c49c5-1918-4deb-9ec1-32dfc99c7b9d/HWN20_FlowerPot_05.glb"
);
...
const gltfShape18 = new GLTFShape(
  "0c3187bb-e9ee-4ac9-9ec3-edb6a40e818b/WhiteRoof_4Edges_Small.glb"
);
...
const gltfShape16 = new GLTFShape(
  "ac62c7f6-6ffd-485d-a189-b1236ca94e98/Module_Stair_Straight_3M/Module_Stair_Straight_3M.glb"
);
...
const gltfShape17 = new GLTFShape(
  "d6cbb77a-a9c5-40a3-8eba-7bdf86fc3747/LightWall_01/LightWall_01.glb"
);
...
script1.spawn(
  ropeLight,
  {
    startOn: true,
    clickable: true,
    onActivate: [{ entityName: "ropeLight", actionId: "activate", values: {} }],
    onDeactivate: [
      { entityName: "ropeLight", actionId: "activate", values: {} },
    ],
  },
  createChannel(channelId, ropeLight, channelBus)
);
// script2.spawn(messageBubble, {"text": repliedMessage,"fontSize":15}, createChannel(channelId, messageBubble, channelBus))
script3.spawn(
  plainText,
  { text: "Gupshup Bank", font: "SF_Heavy", color: "#3A3B3C" },
